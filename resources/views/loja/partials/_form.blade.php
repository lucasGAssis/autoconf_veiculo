...
@endif
    ...
    <div class="form-row">
        <div class="col-md-4 mb-3">
            ...
            <input class="text-uppercase form-control @if($errors->{$errorBag}->has('cep')) is-invalid @endif" type="text" name="cep" id="_cep" value="{{old('cep', !empty($loja->cep) ? $loja->cep : '')}}">
    ...
    <div class="form-row">
        <div class="col-md-4 mb-3">
            ...
            <input class="text-uppercase form-control @if($errors->{$errorBag}->has('estado')) is-invalid @endif" type="text" name="estado" id="_estado" value="{{old('estado', !empty($loja->estado) ? $loja->estado : '')}}">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input class="text-uppercase form-control @if($errors->{$errorBag}->has('cidade')) is-invalid @endif" type="text" name="cidade" id="_cidade" value="{{old('cidade', !empty($loja->cidade) ? $loja->cidade : '')}}">
    ...
    <div class="form-row">
        <div class="col-md-4 mb-3">
            ...
            <input class="text-uppercase form-control @if($errors->{$errorBag}->has('bairro')) is-invalid @endif" type="text" name="bairro" id="_bairro" value="{{old('bairro', !empty($loja->bairro) ? $loja->bairro : '')}}">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input class="text-uppercase form-control @if($errors->{$errorBag}->has('logradouro')) is-invalid @endif" type="text" name="logradouro" id="_logradouro" value="{{old('logradouro', !empty($loja->logradouro) ? $loja->logradouro : '')}}">
            @if($errors->{$errorBag}->has('logradouro'))
            <div class="invalid-feedback"> {{$errors->{$errorBag}->first('logradouro')}}</div>
            @endif
        </div>
    </div>
    <div class="form-row">
        <div class="col-md-2 mb-3">
            ...
            <input class="text-uppercase form-control @if($errors->{$errorBag}->has('numero')) is-invalid @endif" type="text" name="numero" id="_numero" value="{{old('numero', !empty($loja->numero) ? $loja->numero : '')}}">
        ...
        <div class="col-md-2 mb-3">
            ...
            <input class="text-uppercase form-control @if($errors->{$errorBag}->has('complemento')) is-invalid @endif" type="text" name="complemento" id="_complemento" value="{{old('complemento', !empty($loja->complemento) ? $loja->complemento : '')}}">
